...
def main():
    # Looks for mounted ConfigMap path inside container, falls back to local relative path
    ...
    # Initialize ResNet-18 model architecture
    model = get_model(
    ...
    for epoch in range(config["training"]["epochs"]):
        ...
        # Log structured JSON lines to stdout
        log_entry = {
            "epoch": epoch + 1,
